...
# print the calories of fruit ask by user

def calorie(item):
    fruitlist={ "apple":130, "avocado":50, "banana":110, "cantaloupe":50, "grapefruit":60,
    ...
    for diet in fruitlist:
        if diet == item:
            print("Calories:",fruitlist[diet])
